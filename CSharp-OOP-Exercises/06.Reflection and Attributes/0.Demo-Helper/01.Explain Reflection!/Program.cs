namespace SystemTypeMethods
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            //Getting Private Fields Info
            Console.WriteLine();
            Console.WriteLine("Getting Private Fields Info");
            Person person = new Person("Nasko",33);
            Type type = typeof(Person);
            FieldInfo getPrivateField = type.GetField("age", BindingFlags.Instance | BindingFlags.NonPublic);
            object objInst = Activator.CreateInstance(type, "Pesho",10);
            var resultPrivateField = getPrivateField.GetValue(person);
            Console.WriteLine();
            Console.WriteLine($"The private int age was found and has value of : {resultPrivateField}");
            Console.WriteLine(new string ('$',60));
            // Methods Info
